...
class Admin extends Admin_Controller
{
        ...
        function class_teacher($id = FALSE, $page = 0)
        {
                ...
                $the_class = $this->class_groups_m->get_class($id);
                ...
                if ($this->form_validation->run())  //validation has been passed
                {
                        ...
                        $form_data = array(
                            ...
                            'modified_by' => $user->id,
                            'modified_on' => time());
                        $done = $this->class_groups_m->classes_update($the_class->id, $form_data);
                ...
                $data['result'] = $get;
                //load the view and the layout
                $this->template->title('Add Class Teacher ')->build('admin/teacher', $data);
        }

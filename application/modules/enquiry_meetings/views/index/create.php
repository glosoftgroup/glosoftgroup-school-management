...
<div class="col-md-6">
				...
				$head = $this->ion_auth->get_headteachers();		
     echo form_dropdown('person_to_meet',array(''=>'Select Staff')+$teachers+$head,  (isset($result->person_to_meet)) ? $result->person_to_meet : ''     ,   ' class="chzn-select" data-placeholder="Select Options..." ');
...
<div class='widget'>
  <div class='head dark'>
	...
	<textarea id="reason"   style="height: 180px;" class="col-sm-12 "  name="reason"  /><?php echo set_value('reason', (isset($result->reason)) ? htmlspecialchars_decode($result->reason) : ''); ?></textarea>
...
<div class="col-md-6">
	...
	<?php echo anchor('enquiry_meetings/meetings','Cancel','class="btn  btn-default"');?>
</div>
</div>
</div>

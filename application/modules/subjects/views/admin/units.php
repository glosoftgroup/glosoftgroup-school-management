<div class="col-md-12">
  <div class="panel panel-white">
    <div class="panel-heading">
      <h2 class="panel-title">  Assign Sub Units For <?php echo $sub->name; ?> </h2>
        ...
        <div class="widget col-md-12">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                         <?php echo form_input('name', '', 'id="name" class="form-control" placeholder="Unit Title" '); ?>
                         <?php echo form_error('name'); ?>
                    </div>
                    <div class="col-md-2">
                         <?php echo form_input('out_of', '', 'id="out_of"  class="form-control" placeholder="Marks Out of" '); ?>

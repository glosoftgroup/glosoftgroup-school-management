        ...
        if ($this->form_validation->run())  //validation has been passed
        {
            ...
            foreach ($_FILES as $index => $value)
            {
                if ($value['name'] != '')
                {
                    ...
                    if ($index == 'receipt')
                    {
                        $this->upload->initialize($this->set_upload_options('add_stock', 'receipt'));
                    }
                    ...
                    else
                    {
                        ...
                        array_push($files_to_delete, $data['add_stock_m']->$index);
            ...
            if ($add_stock_m)
            {
                ...
                {
                    if (is_file(FCPATH . 'uploads/add_stock/files/' . $index))
                        unlink(FCPATH . 'uploads/add_stock/files/' . $index);
                }

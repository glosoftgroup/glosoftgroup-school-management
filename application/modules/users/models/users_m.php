...
class Users_m extends MY_Model
{
        ...
        function get_datatable($iDisplayStart, $iDisplayLength, $iSortCol_0, $iSortingCols, $sSearch, $sEcho)
        {
                ...
                // Select Data
                $this->db->select('SQL_CALC_FOUND_ROWS id, ' . $this->dx('first_name') . ' as first_name,' . $this->dxa('last_name') . ',' . $this->dxa('active') . ',' . $this->dxa('email') . ',' . $this->dxa('last_login') . ',' . $this->dxa('phone'), FALSE);
        ...
        function filter_users($gid, $iDisplayStart, $iDisplayLength, $iSortCol_0, $iSortingCols, $sSearch, $sEcho)
        {
                ...
                // Select Data
                // Select Data
                $this->db->where($this->dx('users_groups.group_id') . '=' . $gid, NULL, FALSE)->get('users_groups');

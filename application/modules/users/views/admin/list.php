    ...
    $(document).ready(function() {
        ...
        oTable = $('#users_tbb').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex) {
                ...
                $("td:last", nRow).html(" <a class='btn btn-primary' href ='<?php echo base_url('admin/users/edit/'); ?>" + "/" + aData[0] + "' ><i class='icon-pencil7'></i></a> <a onClick='return confirm(\"Are you sure you want to suspend this user?\")' class='kftt btn btn-danger' href ='<?php echo base_url('admin/users/suspend/'); ?>" + "/" + aData[0] + "' ' ><i class='icon-trash'></i></a>" + '. ');
                return nRow;
            },
            "oLanguage": {

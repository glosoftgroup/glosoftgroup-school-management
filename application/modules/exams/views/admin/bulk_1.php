                       ...
                       <div class="docpg">
                           <div class="row-fluid">
                               ...
                               <div class="col-xs-2 hpe">
                                    ...
                                    {
                                         ?>
                                        <img src="<?php echo base_url('uploads/' . $rw->student->pass->fpath . '/' . $rw->student->pass->filename); ?>" alt="">
                                   <?php } ?>
                               </div>
                           </div>
                           <div class="row-fluid">
                               <table class="topdets table">
                                   <tr>
                                       ...
                                       <td><em>ADMIN NO: </em> <abbr title="Reg No">
                                   ...
                                   ?>
                                   <tr>
                                       <td><strong>Class POS: </strong> <?php echo $j; ?></td>
                                       <td>
                                           <strong>Out of : </strong><?php echo count($payload); ?>
                                           <?php ?>
                                       </td>
                                       <td><strong>T.MARKS: </strong><?php echo $stot ?></td>
                                       <td>
                                           <strong>M.MARK:</strong> <?php echo round($stot / $ix); ?>
                                           <?php ?>
                                       </td>
                                   </tr>
                               </table>
                                   ...
                                   <td class="nob">
                                       <div>						 
                                           <div class="foo">
                                               ...
                                               <br><span><?php echo isset($rw->report['remarks']) && $rw->report['remarks'] != '' ? $rw->report['remarks'] : '<hr style="border-bottom:dotted; white-space: pre;"/>'; ?> </span>
                                           </div>
                                           <br><span style="text-decoration:underline">Head Teacher’s Remarks:</span>

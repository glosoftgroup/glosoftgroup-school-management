      ...
      <div class="panel-body">
        ...
        <div class='form-group'>
            <div class="col-md-2" for='title'>Title </div><div class="col-md-10">
                <?php
                echo form_dropdown('title', $items, (isset($result->title)) ? $result->title : '', ' class="select title" id="title"   data-placeholder="Select Options..." ');
        ...
        <div class='form-group'>
            ...
            <div class="col-md-10">
                <?php
                echo form_dropdown('category', $cats, (isset($result->category)) ? $result->category : '', ' class="select chzn-select" data-placeholder="Select Options..." ');
        ...
        <div class='form-group'>
            ...
            <div class="col-md-10">
                ...
                echo form_dropdown('person_responsible', array('' => 'Select Staff') + $staff, (isset($result->person_responsible)) ? $result->person_responsible : '', ' class="select chzn-select" data-placeholder="Select Options..." ');
 ...
 <div class="panel panel-body">
    <div class="widget ">
        ...
        <div class="block-fluid">
            ...
            <div class="col-md-12 TAR p-10 text-right">
    ...
    <div class="widget">
        ...
        <div class="block-fluid">
            <?php echo form_open('admin/expenses_category/quick_add', ''); ?>
            <div class="form-group">
                <div class="col-md-3">Name:</div>
                <div class="col-md-9">                                      
                    <?php echo form_input('title', '', 'id="title_1" class="form-control"  placeholder=" e.g Stationary, Water, Electricity etc."'); ?>
                    <?php echo form_error('title'); ?>
                </div>
            </div>
            <div class="col-md-12 TAR text-right p-10">

                 ...
                 <tbody>
                      ...
                      foreach ($record_salaries as $p):
                          ...
                          <tr>
                              ...
                              <td >
                                  <div class='btn-group'>
                                      <a class="btn btn-success" href='<?php echo site_url('admin/record_salaries/employees/' . $p->salary_date); ?>'><i class='glyphicon glyphicon-eye-open'></i> View Paid Employees</a>
                                      <a class="btn btn-danger" href='<?php echo site_url('admin/record_salaries/delete/' . $p->id); ?>' onClick="return confirm('<?php echo lang('web_confirm_delete') ?>')"><i class='glyphicon glyphicon-trash'></i> Void</a>
                                  </div>
                              </td>
                          </tr>
                     <?php endforeach ?>

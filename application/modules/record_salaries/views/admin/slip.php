            ...
            <table width="100%" >
                ...
                <tr>
                    ...
                    <td>
                        <div class="inner_items">
                            <div class="item">
                                Taxable Pay : <?php echo number_format($post->basic_salary, 2);
                            ?>
                                <div class="right">
                                    <table class="fless" border="0">
                                        ...
                                        {
                                                $e++;
                                                $amt = $e == 1 ? $R->amount : $post->basic_salary - $poc_amt;
                                                if ($e == 1 && $post->basic_salary < $R->amount)
                                                {
                                                        $amt = $post->basic_salary;
                                                }
                                                if ($amt < 0)
                                                {
                                                        $amt = 0;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right"><?php echo $R->range_to > 42784 ? '- ' : number_format($R->range_to); ?></td>
                    ...
                    <td>
                        <div class="item">
                            ...
                            <div class="right" style="border-bottom:1px solid #ccc">  <?php
                                ...
                                $t_deductions = ($post->advance + $minn + $post->total_deductions + $post->nhif + $post->staff_deduction);

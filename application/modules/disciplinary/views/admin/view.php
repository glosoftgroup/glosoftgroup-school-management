						...
						<div  <?php if(empty($post->action_taken)) echo 'class="left"';?>>
						 <div class="image ">
                           ...
                           <div class="item">
									...
									<div class="descr"><?php $user=$this->ion_auth->get_user($post->created_by);   echo $user->first_name.' '.$user->last_name;?></div>
							</div>
						</div>
                        ...
                        <div class="stats">
							...
							<div class="left">
								<div class="item">
									...
									<div class="descr"><?php $user=$this->ion_auth->get_user($post->modified_by);   echo $user->first_name.' '.$user->last_name;?></div>
								</div>

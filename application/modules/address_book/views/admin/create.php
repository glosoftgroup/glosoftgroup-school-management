...
<div class='form-group'>
	 <div class="col-md-3" for='address_book'>Address Book <span class='required'>*</span></div>
<div class="col-md-6">
                <?php $items = array('' =>'', 
"supplier"=>"Supplier",
"customer"=>"Customer",
"others"=>"Others",
     ...
     echo form_dropdown('address_book', array(''=>'Select Address Book')+$items,  (isset($result->address_book)) ? $result->address_book : ''     ,   ' class="select" data-placeholder="Select Options..." ');
     echo form_error('address_book'); ?>
</div></div>

<div class='form-group'>
	 <div class="col-md-3" for='title'>Contact Person <span class='required'>*</span></div><div class="col-md-6">
...
<div class='form-group'>
	 <div class="col-md-3" for='category'>Category</div>
<div class="col-md-6">
                <?php 
...
<div class='form-group'>
	 <div class="col-md-3" for='company_name'>Company Name </div><div class="col-md-6">
	<?php echo form_input('company_name' ,$result->company_name , 'id="company_name_"  class="form-control" ' );?>
 	<?php echo form_error('company_name'); ?>
</div>
</div>

<div class='form-group'>
	 <div class="col-md-3" for='phone'>Cell Phone <span class='required'>*</span></div><div class="col-md-6">
...
<div class='form-group'>
	 <div class="col-md-3" for='landline'>Telephone </div><div class="col-md-6">
	<?php echo form_input('landline' ,$result->landline , 'id="landline_"  class="form-control" ' );?>
...
<div class='form-group'>
	 <div class="col-md-3" for='address'>Address </div><div class="col-md-6">
...
<div class='form-group'>
	 <div class="col-md-3" for='city'>City </div><div class="col-md-6">
...
<div class='form-group'>
	 <div class="col-md-3" for='country'>Country </div>
<div class="col-md-6">
                <?php 		
     echo form_dropdown('country',array('kenya'=>'Kenya')+ $countries,  (isset($result->country)) ? $result->country : ''     ,   ' class="select" data-placeholder="Select Options..." ');
...
<div class="col-md-12 text-right p-10">
	...
	<?php echo anchor('admin/address_book','Cancel','class="btn btn-danger"');?>
</div></div>
 </div>
<?php echo form_close(); ?>

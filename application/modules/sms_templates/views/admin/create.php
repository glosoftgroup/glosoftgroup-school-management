...
<div class='widget'>
  <div class='head dark'>
	...
	<textarea id="sms_body"   style="height: 300px;" class=" wysihtml5 wysihtml5-min"  name="sms_body"  /><?php echo set_value('sms_body', (isset($result->sms_body)) ? htmlspecialchars_decode($result->sms_body) : ''); ?></textarea>

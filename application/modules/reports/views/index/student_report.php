...
<?php if(isset($student) && !empty($student)){?>
                <div class=" ">
                    ...
                    <div class="center">
					   ...
					   <h4> <abbr><?php echo ucwords($student->first_name . ' ' . $student->last_name); ?> </abbr></h4>
                        ...
                        <span> ADM NO. <?php if (!empty($student->old_adm_no))  echo $student->old_adm_no; else echo $student->admission_number;?></span> |   <span>Admission Date: <?php echo date('d M Y', $student->admission_date); ?></span>
						<br>
					  <b>Birthday:</b> <?php echo $student->dob > 1000 ? date('d M Y', $student->dob) : ''; ?> | 
					   <b>Gender:</b> <?php
                        if ($student->gender == 1) echo 'Male';else echo 'Female';?>
						<br>
			  ...
			  <div class="col-sm-12">
                    ...
                    <p> <b><abbr title="House">House:</abbr></b> <?php $hse = $this->ion_auth->list_house();if ($student->house && isset($hse[$student->house])) echo $hse[$student->house]; ?> </p>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($disciplinary as $p):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if(isset($p->action_taken)) echo $p->action_taken; else echo '<i>Still Pending</i>'; ?>
                                                        </td>
                                                        <td>

                           ...
                           <tbody>
                                ...
                                foreach ($sp as $kky => $dd)
                                {
                                    ...
                                    <tr>
                                        ...
                                        ?> 
                                        <td class="rttb"><?php echo isset($dd['tots']) ? $dd['tots'] - $rem : ''; ?></td>
                                        <td class="rttb"><?php echo isset($dd['tots']) ? number_format(round($dd['tots'] / 5, 1), 1) : ''; ?></td>
                                    </tr>

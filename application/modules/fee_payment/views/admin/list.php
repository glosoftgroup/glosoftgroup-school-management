...
<div class="panel panel-white animated fadeIn">
    ...
    <table class="table table-hover" id="feee" cellpadding="0" cellspacing="0" width="100%">
        <thead>
        <th>#</th>
        <th  width="10%">Date</th>
        <th>Student.</th>
        ...
        $(document).ready(function () {
            ...
            oTable = $('#feee').dataTable({
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    ...
                    $("td:last", nRow).html("  <div class='btn-group'><a class='btn btn-success' href ='<?php echo base_url('admin/fee_payment/receipt/'); ?>" + "/" + aData[7] + "' >Receipt</a><a class='btn btn-primary' href ='<?php echo base_url('admin/fee_payment/edit/'); ?>" + "/" + aData[0] + "' >Edit</a><a onClick='return confirm(\"Are you sure you want to void this payment? (IRREVERSIBLE)\")' class='btn btn-danger' href ='<?php echo base_url('admin/fee_payment/void/'); ?>" + "/" + aData[0] + "' >Void</a> " + '</div>');
                    return nRow;
                },
                "oLanguage": {

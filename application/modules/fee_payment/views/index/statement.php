            ...
            <div class="block invoice slip-content">
				...
				<div class="center">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-10 ">
                            <b>Student:</b>
                            <abbr title="Name" ><?php echo $post->first_name . ' ' . $post->last_name; ?> </abbr>
                            <span class="right">
                                                        ...
                                                        ?><tr>
															...
															<?php
                                                                $mess = ucwords($paid->desc);
																 if(is_numeric($mess) && $mess==0) $mess = 'Tuition Fee Payment'; 
																 elseif(is_numeric($mess)) $mess = $extras[$mess]; 
                        ...
                        <div class="total"> 
                            <?php if ($ibal < 0): ?>
                                    <span class="highlight">
                                        <strong><span>Overpay:</span> <?php //echo $this->currency;?> <?php echo number_format($ibal, 2); ?>   <em></em></strong>
                                    </span>
                            <?php else: ?>
                                    <span class="highlight">

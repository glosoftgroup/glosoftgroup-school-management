    ...
    <div class="submain">
        ...
        <div id="default">
            ...
            <div class="widget-fluid userInfo clearfix">
                ...
                <div class="text">
                    Welcome <?php echo trim($user->first_name . ' ' . $user->last_name); ?>!
                    <p>Your last visit: <?php echo $this->ion_auth->get_user()->last_login ? date('d M Y H:i', $this->ion_auth->get_user()->last_login) : 'Never'; ?>
                    </p>
                </div>
            </div>

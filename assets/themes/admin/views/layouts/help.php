    ...
    <body class="ssGreen">
        ...
        <div id="documenter_content">
            ...
            <section id="administration">
                ...
                <h4 id="student_attachment">Student Attachments</h4>
                The Attachments section allows the administrator track all the students going for industrial attachments. It displays all the students who are currently on internships as well as those who have completed and were assessed by their assigned supervisors. To add a student to the attachments list, click on the '+Add Attachment' button, fill-in all the fields, click on 'Save' to save and exit. A sample page for adding a student to the attachment list looks like this:<br>
                <p class="help-img"><?php echo theme_image('help/attacho.jpg'); ?><p>
                <h4>Enquiries</h4>
                The Enquiries section displays all the enquiries done by potential students that were recorded by the front-desk staff during a school calendar or semester. They are then stored securely on the institutions database until they are manually deleted by the administrator. To add an enquiry, click on the '+Add Enquiries' button, fill-in all the fields on the form then click on 'Save'.<br>
                <p class="help-img"><?php echo theme_image('help/enquiries.jpg'); ?><p>
                <h4>Recommend A Friend</h4>
                The Recommend a Friend section allows students, the administrator and any other authorized users recommend courses to other students that they think they will be good at. To recommend a course, click on the '+Add Recommend Friend' button, fill-in all the fields plus the course you recommend then click on 'Save' button. A sample page for recommending a course to a friend is displayed below:<br>
                <p class="help-img"><?php echo theme_image('help/recommendfriend.jpg'); ?><p>
            ...
            <section id="library">
                ...
                <section id="communication">
                    ...
                    Here are the sub-menus found under the library section:<br><br>
                    <h4>Meetings</h4>
                    <p class="help-img"><?php echo theme_image('help/meetings.jpg'); ?><p>
                        From this page, the administrator can view existing and pending meetings as they will be listed according to date. By clicking on the "Full Details" button under the Options column, the user is able to view each meeting in detail.A sample page looks like this:<br>
                    <p class="help-img"><?php echo theme_image('help/viewfullcalendar.jpg'); ?><p>
                        To add a new meeting, simply click on the "+Add Meetings" button, fill-in all the fields then click on Save. Here is a sample Add Event page:<br>
                    <p class="help-img"><?php echo theme_image('help/addmeeting.jpg'); ?><p>
                    <h4>Emails</h4>
                    <p class="help-img"><?php echo theme_image('help/emails.jpg'); ?><p>
                        This page allows the administrator to compose and send emails to the people on the school's mailing list, they may include parents, staff, students e.tc. The messages are stored on the database until they are manually deleted by the administrator. 
                    <h4>SMS Messaging</h4>
